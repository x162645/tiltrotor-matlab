...
add_close('rotor blade inertia recomputed from public radius', ...
    P.rotor.Ib, P.rotor.bladeMass*P.rotor.R^2/3, 1e-12);
add_close('rotor blade first mass moment recomputed from public radius', ...
    P.rotor.Sblade, P.rotor.bladeMass*P.rotor.R/2, 1e-12);
...
add_case('retained non-XV15 fields are explicitly marked', ...
    ...
    isfield(P.rotor,'derivedAssumptionStatus') && ...
...
add_case('nacelle conversion source points to SP-2000-4517', ...
    isfield(P,'nacelle') && isfield(P.nacelle,'publicReferenceSource') && ...
    contains(P.nacelle.publicReferenceSource,'NASA_SP_2000_4517'), ...
    'Nacelle convention/rate source metadata must point to SP-2000-4517.');

allValues = [P.mass.m; P.wing.S; P.wing.b; P.wing.c; P.rotor.R; ...
    P.rotor.chord; P.rotor.Ib; P.rotor.Sblade; ...
    P.rotor.OmegaHelicopter; P.rotor.OmegaAirplane; ...
