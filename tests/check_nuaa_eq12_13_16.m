    ...
    function result = test_eq16_area_grid()
        ...
        for iBeta = 1:numel(betasDeg)
            ...
            for iMu = 1:numel(mus)
                ...
                angleArgErr = abs(out.slipstreamAngleArgument - ...
                    slipstreamAngleArgument);
                betaCodeErr = abs(out.betaMCode - betaM);
                ...
                caseOk = strcmp(out.slipstreamAreaModel, ...
                    ...
                    complementErr < 1e-13 && angleArgErr < 1e-13 && ...
                    betaCodeErr < 1e-13 && ~isfield(out, 'betaPaper') && ...
                    flagsOk;
                ok = ok && caseOk;
