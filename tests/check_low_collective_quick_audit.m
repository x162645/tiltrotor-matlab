...
add_case('isolated baseline identity', ...
    ...
    'merge-base HEAD dad5be2f1257599301d5337e921805b61fd8c486')), ...
    'dad5be2f1257599301d5337e921805b61fd8c486'), ...
    'Audit branch is not based on the recorded PR #58 remote HEAD.');
...
for k = [2,3]
    prod = result.productionResults(k);
    ok = ~prod.success && strcmp(prod.errorIdentifier, ...
