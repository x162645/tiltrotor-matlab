...
comparisons(end+1) = comparison_item( ...
    ...
    'diffCyclic does not enter lateral flapping b1 in the current model.', ...
    'MODEL_STRUCTURE_ZERO');
comparisons(end+1) = comparison_item( ...
...
comparisons(end+1) = comparison_item( ...
    ...
    'Raw dMx is near zero; pdot response is dominated by inertia coupling from Mz.', '');
comparisons(end+1) = comparison_item( ...
