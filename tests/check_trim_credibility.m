...
fprintf('All trim credibility Stage 2/3 checks passed: %d\n', ...
    ...
    function test_representative_cases()
        specifications = { ...
            ...
            'conversion_longitudinal', 35, pi/4, 'CAUTION'; ...
            'airplane_longitudinal', 100, pi/2, 'PASS'};
        expectedScaled = { ...
            [-3.446656462627e-02, 1.708354704914e-01, 1.846547788791e-02; ...
             -2.925193594758e-02,-1.513838411512e+00, 1.002123313291e-03; ...
             -2.648473829037e-02, 1.442150700436e-02,-2.723369574496e-02], ...
            [-4.608820610690e-03, 1.026881574954e+00,-4.807844130578e-03; ...
             -5.776485146509e-02,-1.346656398326e+00,-6.966204502882e-03; ...
             -7.416317029192e-02, 1.288179802720e-01, 2.911260407764e-02], ...
            [ 1.752725662813e-02, 2.609423920364e+00, 2.596651728012e-03; ...
             -3.635249754369e-01,-2.736091586743e-03,-2.563333346947e-02; ...
             -7.705405223136e-01,-7.130925112663e-01,-2.663816201848e-01]};
        ...
        lowNames = {conversion.marginItems( ...
            strcmp({conversion.marginItems.level}, 'LOW')).name};
        assert(all(ismember({'pitchCommand','cyclicLong','elevator'}, ...
            lowNames)));
        expectedMargin = 6.629603983138e-2;
