...
P=params_nominal();
% NUMERICAL ONLY: same maximum-iteration allowance for M0 and M1. The
% production tolerances, relaxation, equations and physical parameters are
% unchanged. This prevents a default iteration cap from masquerading as a
% model-form difference in strict hover.
P.rotor.inducedMaxIter=200;
...
metadata=table( ...
    {'role';'aircraft_parameter_set';'xv15_parameters_exported'; ...
     ...
     'induced_max_iter';'numerical_change_role';'validation_claim';'next_gate'}, ...
    {'WHOLE_AIRCRAFT_HOVER_MODEL_FORM_PROPAGATION_SENSITIVITY'; ...
     'PARAMS_NOMINAL_GENERIC_CONCEPT';'NO';'STRICT_HOVER_ONLY';'ZERO'; ...
     'BETA_M_ZERO';'TWO_ROTORS_SUPPORT_MG';'200'; ...
     'MAX_ITER_CAP_ONLY_SAME_TOLERANCE_RELAXATION_AND_PHYSICS'; ...
