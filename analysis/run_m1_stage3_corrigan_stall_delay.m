...
%   2) CORRIGAN_GENERIC_N1   - predeclared in-range n=1 model-form choice;
...
% parameter. Koning documents a range for n; n=1 is not claimed as a
% unique or universal literature default. The n=1.8 branch must not be
% used as independent validation evidence because its source paper selected
% it in XV-15 correlation work.
...
role = {'M1_B_RIGID_REFERENCE'; ...
    'M1_E_PREDECLARED_IN_RANGE_CORRIGAN_N1_MODEL_FORM_ASSUMPTION'; ...
...
metadataValue = { ...
    ...
    'M1_B_SOURCE_INFORMED_GEOMETRY_SPANWISE_C81_GLOBAL_MOMENTUM'; ...
    'FIXED_6_TO_11_DEG';'DEVELOPMENT_EXTERNAL_CORRELATION'; ...
    'YES_OFF_N1_N1P8_ONLY';'NO'; ...
    'PREDECLARED_IN_RANGE_CORRIGAN_N1_MODEL_FORM_ASSUMPTION_NOT_UNIVERSAL_LITERATURE_DEFAULT'; ...
...
results.claimBoundary = [ ...
    ...
    'N1_IS_IN_RANGE_MODEL_FORM_ASSUMPTION_N1P8_EXPLICITLY_NONINDEPENDENT'];
