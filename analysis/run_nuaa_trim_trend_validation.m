...
P = params_nominal();
stamp = [datestr(now, 'yyyymmdd_HHMMSS') '_eq12_17_complete'];
...
fprintf(fid, '## Active Wing Slipstream Chain\n\n');
fprintf(fid, ['This run uses the post-correction wing chain: NUAA Eq. (16) ' ...
    'area formula with a separate physical area guard, NUAA Eq. (17) ' ...
    'body-axis induced-velocity vector, Eq. (18) aerodynamic-center shift, ' ...
    'Eq. (19)/(21) force transformation as a three-dimensional extension, ' ...
    'and Eq. (20)/(22) force-arm moment identities. The legacy ' ...
    '`P.rotor.wakeFactor` path is deprecated and is not used by production ' ...
    'wing force, moment, or local-velocity calculations. Earlier ' ...
    '`20260625_eq12_13_16` and `20260625_eq12_13_16_angle_fix` outputs are ' ...
    'intermediate diagnostics from before Eq. (17) replaced that legacy path.\n\n']);
