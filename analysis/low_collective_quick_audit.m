...
try
    ...
    production.returned = true;
    production.numericalConverged = out.coupledConverged;
    production.physicalConverged = out.physicalConverged;
    production.success = out.physicalConverged;
    production.exitReason = out.physicalStatus;
    production.physicalStatus = out.physicalStatus;
    production.physicalBranchSupported = out.physicalBranchSupported;
    production.closureResidualSatisfied = ...
        out.closureResidualSatisfied;
    production.closureResidual = out.inducedClosureResidual;
...
for j = 1:count
    row = table(collectiveDeg, j, loads.rMid(j)/P.rotor.R, ...
        ...
        diagnostic.branchSwitch, {region}, production.returned, ...
        production.numericalConverged, production.physicalConverged, ...
        production.success, {production.physicalStatus}, ...
        production.physicalBranchSupported, ...
        production.closureResidualSatisfied, ...
        production.closureResidual, ...
        ...
        'region_class','production_returned', ...
        'production_numerical_converged', ...
        'production_physical_converged','production_success', ...
        'production_physical_status', ...
        'production_physical_branch_supported', ...
        'production_closure_residual_satisfied', ...
        'production_closure_residual_N', ...
        'production_error_identifier', ...
...
fprintf(fid, ['production_model_modified=true; equations and default parameters unchanged; ' ...
    'physical-convergence status and propagation added\n']);
...
production = struct('returned',false,'success',false, ...
    'numericalConverged',false,'physicalConverged',false, ...
    'physicalStatus','NOT_RUN','physicalBranchSupported',false, ...
    'closureResidualSatisfied',false,'closureResidual',NaN, ...
    'exitReason','NOT_RUN', ...
