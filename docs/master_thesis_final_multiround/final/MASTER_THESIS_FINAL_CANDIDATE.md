...
![加密速度短舱角转换走廊](figures/16_加密转换走廊.png)
...
\(C_T/\sigma\) 约0.063—0.064的平均绝对偏差。三项贡献均在通用低阶模型范围内
...
当前正式旋翼的共同有效点数为7，失败点为6°、8°、10°；南航公开公式参考旋翼的
有效点数为7，失败点为0°、2°、4°、6°、8°。最终采用的MAE分别为0.0632355和
0.0640525，RMSE分别为0.0633217和0.0640844。任何图题和摘要引用均以这些二次复核值
为准。
