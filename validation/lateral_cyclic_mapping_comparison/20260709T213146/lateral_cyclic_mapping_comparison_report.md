...
A sign change across betaM representative points is not by itself a bug. Nacelle angle changes rotor-axis and disk-plane projections into body axes, plus inflow, flapping, moment-arm, and aerodynamic coupling. This comparison is limited to model-internal effectiveness of the mapping candidates and does not provide external sign validation.
